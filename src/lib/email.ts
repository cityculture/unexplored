...
export async function sendEmail({
    ...
    subject,
    html,
    from = 'City Culture <team@cityculture.in>',
    cc = [],
    attachments = [],
}: {
    to: string;
...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="header">
                <div class="logo-wrap">
                    <img src="https://cityculture.in/logo.png" alt="City Culture Logo">
                </div>
                <h1>You're In!</h1>
            ...
            <div class="content">
                ...
                <div class="cta-wrap">
                    ...
                    <a href="https://www.cityculture.in/members" class="button">Premium Membership</a>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <p>&copy; {year} City Culture &mdash; a brand of Salty Media Production (OPC) Pvt Ltd.</p>
            <div style="margin-top: 14px;">
                <a href="https://www.cityculture.in/terms">Terms</a>
                <a href="https://www.cityculture.in/privacy-policy">Privacy Policy</a>
                <a href="https://www.cityculture.in/refund-policy">Refund Policy</a>
                <a href="https://www.cityculture.in/safety-guidelines">Safety Guidelines</a>
            </div>
        </div>
    </div>
</body>
...
export function generateMembershipVerificationHtml(name: string, verificationLink: string) {
    ...
    <body>
        <div class="card">
            <img src="https://cityculture.in/logo.png" alt="City Culture" class="logo">
            <h1>Verify Your Membership</h1>
            <p>Hey ${name},<br><br>Welcome to <b>City Culture Premium</b>! You're almost there. Please click the button below to verify your official email and activate your full membership benefits.</p>
            ...
            <div class="footer">
                &copy; 2026 City Culture. India's Open Event Listing & Ticketing Platform.
            </div>
        </div>
    </body>
    </html>
    ...
    <body>
        <div class="container">
            <div class="card">
                ...
                <p>We received a request to reset the password for your <b>City Culture</b> membership account. Click the button below to choose a new password.</p>
            ...
            <div class="footer">
                &copy; ${year} City Culture &mdash; a brand of Salty Media Production (OPC) Pvt Ltd.
            </div>
        </div>
    </body>
    </html>
